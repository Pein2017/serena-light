...
# Disk execution is categorically non-publishing.  The declared transport trust root is the
# directly invoked scripts/backend_eval_bootstrap.py; the sealed image imports this module
# normally and calls main(), so it never enters this branch.
import sys as _entry_sys

if __name__ == "__main__":
    _entry_sys.stderr.write(
        "scripts.backend_eval.admission is not a receipt-producing entrypoint; "
