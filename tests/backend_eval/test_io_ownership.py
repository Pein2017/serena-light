...
OWNERSHIP: frozenset[tuple[str, str, str, str]] = frozenset(
    {
        ...
        ("runtime.py", "_observe_external_path_entry", "os.close", DESCRIPTOR),
        ("runtime.py", "_observe_external_path_entry", "os.readlink", CONFINED),
        ("runtime.py", "_observe_external_path_entry", "os.stat", CONFINED),
        ("runtime.py", "_observe_regular_entry", "os.close", DESCRIPTOR),
        ...
        ("runtime.py", "_open_stable_observation_parent", "os.close", DESCRIPTOR),
