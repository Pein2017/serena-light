...
OWNERSHIP: frozenset[tuple[str, str, str, str]] = frozenset(
    {
        ...
        ("protocol_phase.py", "_duplicate_protocol_run_root", "os.close", DESCRIPTOR),
        ("protocol_phase.py", "_duplicate_protocol_run_root", "os.dup", DESCRIPTOR),
        ("protocol_phase.py", "_duplicate_protocol_run_root", "os.fstat", DESCRIPTOR),
        ("protocol_phase.py", "_open_protocol_artifact_owner_root", "os.open", GUARDED),
        ("protocol_phase.py", "close", "os.close", DESCRIPTOR),
        ...
        ("protocol_witness.py", "_duplicate_owned_run_root", "os.close", DESCRIPTOR),
        ("protocol_witness.py", "_duplicate_owned_run_root", "os.dup", DESCRIPTOR),
        ("protocol_witness.py", "_duplicate_owned_run_root", "os.fstat", DESCRIPTOR),
