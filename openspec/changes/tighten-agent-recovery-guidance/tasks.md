...
- [x] 4.3 Run focused unit/integration suites after each implementation group, then the full deterministic pytest suite, Ruff, Ty, bootstrap, source ownership/provenance, copied-source hashes, and strict OpenSpec validation.
