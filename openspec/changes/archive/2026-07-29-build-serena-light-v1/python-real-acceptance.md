...
**PASS for semantic/liveness at candidate build `d46175203f8b...`: 7 passed
...
```text
5 passed, 1 skipped in 130.95s (production acceptance)
2 passed in 16.71s (real Pyright integration)
```
...
`ready`; isolated pytest runs completed in 31.47s, 32.08s, and 30.09s.
