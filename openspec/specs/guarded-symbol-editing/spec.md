# Guarded Symbol Editing Specification

## Purpose

Define the single authorized v1 editing operation and its trust, hash,
atomicity, timeout, uncertainty, and no-replay contracts.
